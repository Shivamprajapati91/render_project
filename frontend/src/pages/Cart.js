...
const Cart = () => {
  ...
  const totalQty = data.reduce((previousValue,currenteValue)=> previousValue + currenteValue.quantity,0)
             ...
             loading ? (
                <div className='h-36 bg-slate-200 border-slate-300 animate-pulse'>
                  ...
                  <div className='h-36 bg-white'>
                    ...
                    <div className='flex items-center justify-between px-4 gap-2 font-mediun text-lg text-slate-600'>
                     <p>Quantity</p>
                     <p>{totalQty}</p>
                    </div>
                    <div className='flex items-center justify-between px-4 gap-2 font-mediun text-lg text-slate-600'>
